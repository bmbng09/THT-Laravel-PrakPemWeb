...
<div class="min-h-full flex flex-col">
    ...
    <header class="bg-white shadow">
        <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
            <img src="/img/pria.png" alt="" class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center bg-black opacity-30 -z-1 ">
            <div class=""></div>
            <div class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl -z-2" aria-hidden="true">
